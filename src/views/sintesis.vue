  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center
      .col-lg-12.mb-5.bgs.p-4.brad
        figure
          img(src="@/assets/curso/sintesis.svg", alt="Diagrama sobre fundamentos del patronaje de calzado que organiza temas como sistemas de medidas, hormas, relación entre la anatomía del calzado y el pie, herramientas del patronaje y proceso de enmascarado. Incluye subtemas como numeración, dimensiones y clasificación de hormas, así como tipos de pie y pisada. ")
      .col-auto
