...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    figure.estilo___caja_4.mb-5
      img(data-aos="zoom-in")(src="@/assets/curso/temas/img59.png", alt="Marcación del centro en la punta y el talón de la horma usando una regla como guía." style="max-width: 650px").m-auto

    .row.align-items-center.mb-5
      .col-xl
        .row.estilo___caja_20.mb-3(data-aos="fade-right")
          .col-xl-auto
      ...
      .col-xl-auto
        figure(data-aos="fade-left").d-none.d-xl-block
          img(src="@/assets/curso/temas/img61.jpg", alt="" style="max-width: 500px").m-auto
